...
/*Exportamos Skills entre {} porque no es una: export default*/
  ...
  const[t]=useTranslation("global");
     ...
     return (
      <div className="pt-3 pb-3" id="skills">
        <h1 className="text-center font-style pb-4">{t("title.tech")}</h1>
        <Container>
        <CardDeck>
          <Row className="d-flex justify-content-around width:0.5px">
            {/* Frontend */}
            <Col md={4}>
            ...
            <Col md={4}>
              ...
              <Card className="focus mt-2 mb-2">
                <Card.Body>
                    <Card.Title className="text-center  card-title">User Experience</Card.Title>
                  <hr />
                  <Card.Text className="card-text d-flex justify-content-start flex-column">
                    {skills.UserExperience.map((skill, index) => (
                      <span className="p-2" key={index}>
                        <a className="text-dark text-decoration-none" href={skill.link} target="_blank" rel="noopener noreferrer">
                          <Image src={skill.imgSrc} alt={skill.imgAltText} rounded className="image-style m-1"></Image> {skill.skillName}
                        </a>
